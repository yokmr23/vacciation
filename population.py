...
class population:
    def __init__(self) -> None:
        self.df = pd.read_excel(
            'https://www.soumu.go.jp/main_content/000762465.xlsx',
            header=2, index_col=0, skipfooter=2)
        # print(df.columns)
        self.male = self.df.iloc[1, 3:]
        self.female = self.df.iloc[2, 3:]
        self.b = ['総数', '0歳～4歳',
                  '5歳～9歳', '10歳～14歳', '15歳～19歳', '20歳～24歳', '25歳～29歳',
                  '30歳～34歳', '35歳～39歳', '40歳～44歳', '45歳～49歳', '50歳～54歳',
                  '55歳～59歳', '60歳～64歳', '65歳～69歳', '70歳～74歳', '75歳～79歳',
                  '80歳～84歳', '85歳～89歳', '90歳～94歳',
                  '95歳～99歳', '100歳以上']
    ...
    def find_a(self, index, name):
        try:
            if index == 1:
                ...
                self.df3 = self.df[(self.df.都道府県名 == name)
                                   & (self.df.市区町村名 == "-")]
...
class MplCanvas(FigureCanvasQTAgg):
    ...
    def show_population(self, index, city):
        ...
        # print('*** plot')
        datasets0 = {
            0: [self.axes1, self.popul.male[1:],
                '男', 'right', 'b', 5.9e+6, 0],
            1: [self.axes2, self.popul.female[1:],
                '女', 'left', 'r', 0, 5.9e+6],
            2: [self.axes3, self.popul.s_male[1:],
                '男', 'right', 'b', 15000, 0],
            3: [self.axes4, self.popul.s_female[1:],
                '女', 'left', 'r', 0, 15000]
        }
